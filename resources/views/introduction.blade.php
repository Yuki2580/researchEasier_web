...
<html lang=ja dir="ltr">
  ...
  <body>
    ...
    <div class="mainWrapper">
      <div class="contentWrapper">
        <div class="messageWrapper">
          <div class="grid-x">
            <div class="cell large-8 medium-8 headText">@lang('introduction.head')</div>
            <a class="cell large-auto medium-auto nextPage2" href="{{ route('makeFirstProject') }}">@lang('introduction.mes1')</a>
          </div>
        ...
        <div class="grid-x manualJournal">
          ...
          <img class="cell large-5 medium-5 small-12 manual_j_pic_sm"width="100%"  src="img/manual_journal_svg" alt="searchJournal" title="searchJournal">
          <div class="cell large-auto medium-auto small-12">
    ...
    <a class="nextPage" href="{{ route('makeFirstProject') }}">@lang('introduction.mes1')</a>
</div>
