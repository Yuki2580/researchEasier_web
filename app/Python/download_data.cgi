...
#    print("!!!!!!!!!!!!!!!!!!!!")
 #   print(w)
    ...
    if z == "NULL" and y == "NULL":
        print("000")
    elif y == "NULL":
        query = "And(W='" + z + "'" + ",Y<=" + w + ")"
        query= query.replace(' ', '')
        url = "https://api.labs.cognitive.microsoft.com/academic/v1.0/evaluate?"+"expr="+query+"&attributes=Ti,S,Y,VFN,FP,I,V,LP,AA.AuN,Id,BT,PB,CC&count="+count
        ...
        query = "And(W='" + y + "'" + ",Y<=" + w + ")"
        query= query.replace(' ', '')
        url = "https://api.labs.cognitive.microsoft.com/academic/v1.0/evaluate?"+"expr="+query+"&attributes=Ti,S,Y,VFN,RId,FP,I,V,LP,AA.AuN,Id,BT,PB,CC&count="+count
